...
export const Home = () => {
  return (
    <div>
      <h1>These Home Workouts Will Rock Your Body</h1>
      <ol>
        <li>
          <h3>Lunges</h3>
          <ul>
            <li>
              Start by standing with your feet shoulder-width apart and arms
              down at your sides.
            </li>
            <li>
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              Ensuring your knees don’t bow inward or outward, drop down until
        ...
        <li>
          ...
          <ul>
            <li>
              Pick a light set of dumbbells — we recommend 10 pounds to start —
            ...
            <li>
              After a brief pause, bend your elbows and lower the weight back
        ...
        <li>
          ...
          <ul>
            <li>
              Start with a dumbbell in each hand. We recommend no more than 10
              pounds for beginners.
            </li>
            <li>
              Bend forward at the waist so your back is at a 45-degree angle to
            ...
            <li>
              Return to the starting position and repeat with the left arm. This
        ...
        <li>
          ...
          <ul>
            <li>
              Begin standing with a dumbbell in your right hand and your knees
              slightly bent.
            </li>
            <li>
            ...
            <li>
              Repeat 10 to 12 reps before moving the weight to your left hand
        ...
        <li>
          ...
          <ul>
            <li>
              Start by standing upright with your feet shoulder-width apart and
            ...
            <li>
              Jump your feet up to your palms by hinging at the waist. Get your
        ...
        <li>
          ...
          <ul>
            <li>
              Begin in a pushup position with your hand and toes firmly planted
              on the ground, your back straight, and your core tight.
            </li>
            <li>
              Keep your chin slightly tucked and your gaze just in front of your
              hands.
            </li>
            <li>
              Take deep controlled breaths while maintaining tension throughout
              your entire body, so your abs, shoulders, triceps, glutes and
              quads are all engaged.
            </li>
            <li>Complete 2-3 sets of 30 second holds to start.</li>
          </ul>
        </li>
        <li>
          <h3>Glute bridge</h3>
