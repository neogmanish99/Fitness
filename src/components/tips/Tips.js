...
export const Tips = () => {
  return (
    <div>
      <h1>Pro Tips For Staying Healthy</h1>
      <ol>
        <li>
          ...
          <p>
            Keep in mind that certain fruit juices may be almost as bad as soda
            in this regard, as they sometimes contain just as much sugar. Their
            small amounts of antioxidants do not negate the sugar’s harmful
            effects.
          </p>
        </li>
        <li>
        ...
        <li>
          ...
          <p>
            ...
            in unhealthy ingredients like added sugar and refined grains. Thus,
            they provide mostly empty calories.
          </p>
        </li>
        <li>
        ...
        <li>
          ...
          <p>
            ...
            melatonin to be produced as if it were completely dark, helping you
            sleep better.
          </p>
        </li>
        <li>
          ...
          <p>
            Sunlight is a great source of vitamin D. Yet, most people don’t get
            enough sun exposure.
          </p>
          <p>
          ...
          <p>
            ...
            reduced symptoms of depression, and a lower risk of cancer. Vitamin
            D may also help you live longer.
          </p>
        </li>
        <li>
        ...
        <li>
          ...
          <p>
            Eating enough protein is vital for optimal health. What’s more, this
            nutrient is particularly important for weight loss.
          </p>
          <p>
            High protein intake can boost metabolism significantly while making
            you feel full enough to automatically eat fewer calories. It can
            also reduce cravings and your desire to snack late at night.
          </p>
          <p>
